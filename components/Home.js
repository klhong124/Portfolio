    ...
    return (
        <div className="min-h-screen h-screen">
            <div className="absolute z-10 w-screen text-center" >
                ...
                <div className="lg:text-3xl md:text-2xl text-1xl font-semibold mt-6 text-gray-300" data-aos="zoom-in-up" data-aos-delay="100">Web Developer | Front-end Specialist | UX Enthusiast</div>
